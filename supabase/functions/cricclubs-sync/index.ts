...
function parsePlayers(html: string): Player[] {
  ...
  const knownPlayers: Record<string, { name: string; role: string; photoUrl: string; isCaptain?: boolean; isViceCaptain?: boolean }> = {
    ...
    '5104993': { name: 'Aniketh Reddy', role: 'All Rounder', photoUrl: 'https://media.cricclubs.com/documentsRep/profilePics/ae45c62c-218a-43be-bd32-b24bb7ccc2f1.png' },
    ...
    '3486175': { name: 'Jaya Simha Vala', role: 'All Rounder', photoUrl: 'https://media.cricclubs.com/documentsRep/profilePics/default_male_profilePic.png' },
    ...
    '1527482': { name: 'Praneeth Reddy Gaddam', role: 'All Rounder', photoUrl: 'https://media.cricclubs.com/documentsRep/profilePics/74d61df5-2e91-43ed-92b2-cf03fbd202cb.png' },
    ...
    '4187240': { name: 'Premchand Lam', role: 'Batter', photoUrl: 'https://media.cricclubs.com/documentsRep/profilePics/547b5ac0-c173-4b3c-b673-e1f0b26a769c.png' },
